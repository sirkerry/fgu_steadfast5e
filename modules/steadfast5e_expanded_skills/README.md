...
- **Example Uses** — 5 concrete examples
- **GM Guidance** — when to call for the skill and common edge cases
...
**Steadfast5e Expanded Skills** extension (`steadfast5e_expanded_skills.ext`) — the reference entries in this module describe the skill system defined by that extension. The module is reference-only and does not affect any mechanics on its own.
